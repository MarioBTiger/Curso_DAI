...
class RentaController extends Controller
{
    ...
    {
        $rentas=Renta::orderBy('renta_id','DESC')->paginate(3);
    ...
    {
        $this->validate($request,['fecha_registro'=>'required', 'fecha_devolucion'=>'required', 'fecha_entrega'=>'required']);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('renta.index')->with('success','Registro actualizado satisfactoriamente');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('renta.index')->with('success','Registro eliminado satisfactoriamente');
    }
