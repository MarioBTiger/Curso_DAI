...
class ClienteController extends Controller
{
    ...
    {
        $clientes=Cliente::orderBy('cliente_id','DESC')->paginate(3);
    ...
    {
        $this->validate($request,['nombre'=>'required', 'apellido_paterno'=>'required', 'apellido_materno'=>'required', 'fecha_nacimiento'=>'required']);
